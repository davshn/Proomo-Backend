class Api::V1::UsersController < ApplicationController
  ...
  def get_points
    ...
    spent_points = user.purchaces.where(return_code:"OK", payment_method: 'points').select{|x| x.offer_id != nil}.map{|x| Offer.find(x.offer_id).redeem_points}.inject(0){|sum,x| sum + x }
